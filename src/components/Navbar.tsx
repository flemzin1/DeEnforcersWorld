...
const Navbar: React.FC = () => {
  useEffect(() => {
    // Reinitialize Flowbite after component mounts to ensure dropdowns work
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-white-800 md:dark:bg-white-900 dark:border-white-700">
            <li>
              <a href="/" className="block py-2 px-3 text-gray rounded-sm md:bg-transparent md:text-gray-700 md:p-0 md:dark:text-gray-500 dark:bg-gray-600 hover:text-blue-600 md:dark:bg-transparent transition-colors">
                Home
              </a>
            </li>
            <li>
              ...
              >
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownNavbarAboutButton">
            ...
            <li>
              <button
                ...
                data-dropdown-toggle="dropdownNavbarPrograms"
                className="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray md:dark:hover:text-blue-500 dark:focus:text-gray dark:border-gray-700 dark:hover:bg-gray-300 md:dark:hover:bg-transparent"
              >
                Programs
                <svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" fill="none" viewBox="0 0 10 6">
              ...
              <div
                ...
                className="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600"
              >
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownNavbarProgramsButton">
